...
Disadvantages:
This method is not guaranteed a unique solution (so make sure you seed your random seed before you run and MDS algorithm to reproduce!)
...
The method is very sensitive to which distance metric you use, so choose carefully! Along these lines, although Bray-Curtis dissimilarity is extensively used in ordinations (both PCoA and NMDS) in microbial ecology, and is very interpretable, this index is not recommended for statistical ordination.
```{r Implementing NMDS}
